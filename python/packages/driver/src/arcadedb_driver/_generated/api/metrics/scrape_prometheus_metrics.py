...
def sync_detailed(
    *,
    ...
    arcadedb.serverMetrics.prometheus.requireAuthentication=false, which is how most scrape setups run
    it.Requires PrometheusMetricsPlugin: absent unless the metrics plugin is enabled.
